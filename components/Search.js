...
const Search = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="px-6 text-[12px] lg:text-[14px] py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-full group-hover:bg-opacity-0">
          Creators
        </span>
        <motion.div
          variants={{
      ...
      <motion.div
        ...
        className="border-2 overflow-y-scroll text-white border-sky-600 bg-[rgba(0,0,0,1)] absolute right-7 top-16 lg:right-48 lg:top-14 h-80 z-10 mt-2 w-80 rounded-xl shadow-lg"
      >
