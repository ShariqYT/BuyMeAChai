            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <div className='flex flex-col justify-center items-center'>
                        <motion.h2 viewport={{ once: true }} initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }} className="text-xl text-gray-500 font-extrabold tracking-tight md:text-3xl ">
                            About
                        </motion.h2>
                        <motion.div viewport={{ once: true }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.5 }} className='flex justify-center items-center'>
                            <p className='font-Fasthand md:text-6xl text-2xl'> Buy me a chai</p>
                    ...
                    <motion.p viewport={{ once: true }} initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 1 }} className="max-w-2xl mx-auto text-md text-gray-300 md:mt-4">
                        Empowering creators, one chai at a time.
                    </motion.p>
                </div>

                <div className="mt-10">
                    <motion.div viewport={{ once: true }} initial={{ x: -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 1 }} className="text-xl md:text-2xl leading-9 font-bold text-cyan-500">
                        Our Mission
                    </motion.div>
                    <motion.p viewport={{ once: true }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1.5 }} className="mt-2 text-sm md:text-lg leading-8 text-gray-300">
                ...
                <div className="mt-10">
                    ...
                    <motion.p viewport={{once: true}} initial={{x: -100,opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 2.6 }} className="mt-2 text-sm md:text-lg leading-8 text-gray-300">
