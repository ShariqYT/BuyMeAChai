...
const Changelogs = ({ setModal }) => {
  return (
    <div className='bg-[rgba(0,0,0,0.1)] w-full h-full backdrop-filter backdrop-blur-lg fixed z-50'>
      ...
      <div className='flex justify-center  items-center top-[40%] lg:top-[50%] absolute left-[49%] lg:left-[50%]'>
        <div className="w-fit border-2 overflow-hidden  border-cyan-500 rounded-2xl shadow-[0px_0px_20px_#a1a1a1] fixed h-[80vh] lg:h-fit mx-auto z-50 backdrop-filter backdrop-blur-3xl bg-[rgba(0,0,0,0.5)]">
          <svg onClick={() => { setModal(false) }} className='fill-white w-6 lg:left-[93%] left-[85%] sticky top-4 cursor-pointer hover:drop-shadow-[0px_0px_10px_cyan]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" /></svg>
          <div className="px-8 py-10">
            <div className="">
              <ul className="-mb-8 overflow-y-scroll">
                      ...
                      <div className="min-w-0 flex-1 py-0">
                        ...
                        <div className="mt-2 text-white">
                          <p className='lg:text-base text-sm'>
                            - Most content changed
                            <br />
                            - User experience get better
                            <br />
                            - UI improved.
                          </p>
                        </div>
                ...
                <li>
                  <div className="relative">
                    <span className="absolute top-5 left-4 -ml-px h-[13vh] lg:h-[12vh] w-0.5 bg-gray-200" aria-hidden="true"></span>
                    <div className="relative flex items-start space-x-3">
                      <div>
                        <div className="relative px-1 top-2 left-1">
                          <div className="h-4 w-4 bg-blue-400 rounded-full ring-4 ring-white flex items-center justify-center">
