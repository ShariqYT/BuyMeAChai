        ...
        <div className='text-white py-14 container mx-auto'>
            ...
            <div className="social-login-btn">
                <div className="flex flex-col items-center justify-center gap-2 p-10">
                    ...
                    <button
                        onClick={() => signIn('github')} className="flex items-center text-white w-64 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-[#00d0ff] hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
